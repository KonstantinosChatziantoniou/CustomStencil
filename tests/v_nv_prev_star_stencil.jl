...
st_inst = NewStencilInstance(v_def, nv_def, prev_time_coeff=prev_coeff)
...
## CPU Implementation
cpu_out =  cpu_star_stencil_vsq_prev_val(original_data, vsq, radius, coefs, t_steps, prev_coeff)
